...
- **紧凑的二级菜单**：工具条只显示动作分类，点击后选择具体处理方式，动作可排序，二级动作可单独启停。
...
鼠标悬停工具条图标可查看动作名称。带二级选项的动作会打开 Windows 原生菜单，未启用的二级动作不会显示。
...
可在“快捷动作”页面调整动作顺序、关闭不需要的动作或二级选项、配置 JSON 字段或 Schema，并控制是否启用短词词典模式。
